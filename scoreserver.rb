...
helpers do
  ...
  def footer_contents
    return <<-"EOS"
      <div id="footer_item">generated by scoreserver.rb (#{SCORESERVER_VERSION})</div>
      <div id="footer_item">powerd by ruby (#{VERSION})</div>
      <div id="footer_item">founted by yoggy :: team t-dori</div>
    EOS
  end
end
